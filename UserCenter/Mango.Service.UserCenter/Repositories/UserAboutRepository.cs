...
namespace Mango.Service.UserCenter.Repositories
{
    ...
    /// 用户关于页仓储接口实现
    /// </summary>
    public class UserAbountRepository : EfRepository<UserCenterDbContext,UserAbout>,IUserAboutRepository
    {
        public UserAbountRepository(UserCenterDbContext context) : base(context)
        {
