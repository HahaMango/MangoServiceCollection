...
namespace Mango.Service.UserCenter.Repositories
{
    ...
    /// 用户第三方登陆仓储接口实现
    /// </summary>
    public class UserExternalLoginRepository : EfRepository<UserCenterDbContext,UserExternalLogin>,IUserExternalLoginRepository
    {
        public UserExternalLoginRepository(UserCenterDbContext context) : base(context)
        {
