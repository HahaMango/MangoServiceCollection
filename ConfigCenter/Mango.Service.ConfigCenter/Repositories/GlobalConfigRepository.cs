...
namespace Mango.Service.ConfigCenter.Repositories
{
    ...
    /// 全局配置仓储实现
    /// </summary>
    public class GlobalConfigRepository : EfRepository<ConfigCenterDbContext, GlobalConfig>, IGlobalConfigRepository
    {
        public GlobalConfigRepository(ConfigCenterDbContext context) : base(context)
        {
