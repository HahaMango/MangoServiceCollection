...
namespace Mango.Service.ConfigCenter.Repositories
{
    ...
    /// 模块配置仓储实现
    /// </summary>
    public class ModuleConfigRepository : EfRepository<ConfigCenterDbContext, ModuleConfig>, IModuleConfigRepository
    {
        public ModuleConfigRepository(ConfigCenterDbContext context) : base(context)
        {
