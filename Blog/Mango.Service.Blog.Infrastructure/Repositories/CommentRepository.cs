...
namespace Mango.Service.Blog.Infrastructure.Repositories
{
    ...
    public class CommentRepository : ICommentRepository
    {
        ...
        public async Task AddAsync(Comment o)
        {
            await _context.Comments.AddAsync(o);
        }
        ...
        public Task RemoveAsync(Comment o)
        {
            o.Delete();
            _context.Comments.Update(o);
            return Task.CompletedTask;
        }

        public Task UpdateAsync(Comment o)
        {
            _context.Comments.Update(o);
            return Task.CompletedTask;
        }
